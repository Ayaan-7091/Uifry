...
export default function Section1() {
    return (
        <div className="grid grid-cols-2">
            ...
            <div className="main-heading row-span-1 grid-rows-2 gap-6 order-1" style={{ backgroundImage: `url(${blur_img})`, backgroundSize: '38% auto', backgroundRepeat: 'no-repeat', backgroundPosition: 'center top' }}>
