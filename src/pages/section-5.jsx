...
export default function section5(){
    ...
    <div className="header flex flex-col items-center text-center">
        ...
        <h1 className="text-2xl  md:text-6xl font-semibold">What Our Users <br /> Say About Us?</h1>
    </div>
</div>
        ...
        <div className="md:grid md:grid-cols-2">
            ...
            <div className=' pr-12 ' >
                ...
                <p className='text-md md:text-xl text-xs text-slate-800 font-medium'>“Arcu At Dictum Sapien, Mollis. Vulputate Sit Id Accumsan, Ultricies. In Ultrices Malesuada Elit Mauris Etiam Odio. Duis Tristique Lacus, Et Blandit Viverra Nisl Velit. Sed Mattis Rhoncus, Diam Suspendisse Sit Nunc, Gravida Eu. Lectus Eget Eget Ac Dolor Neque Lorem Sapien, Suspendisse Aliquam.”</p>

                <div className="users mt-8 flex ml-20 md:ml-0">
                    <img src={avatar} className='h-10 w-10 mb-4' alt="" />
                    <img src={avatar2} className='h-8 w-8 mt-1 ml-1 opacity-50' alt="" />
                    <img src={avatar3} className='h-8 w-8 mt-1 ml-1 opacity-50'  alt="" />
