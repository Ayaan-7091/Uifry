...
export default function Section2({ darkMode }) {
  return (
    <div className={`grid grid-cols-2 md:pl-8 md:pr-8 pt-8 ${darkMode ? 'bg-gray-900 text-white' : 'bg-white text-black'}`}>
